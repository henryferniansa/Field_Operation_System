...
class _PetaPickerPageState extends State<PetaPickerPage> {
  ...
  void _simpanLokasi() {
    if (_tapX != null && _tapY != null) {
      Navigator.pop(context, {'x': _tapX, 'y': _tapY});
    }
  }
  ...
  void _updateImageSize(BuildContext context) {
    ...
    if (renderObject is RenderBox && renderObject.hasSize) {
      ...
      if (_imgWidth != size.width || _imgHeight != size.height) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: _tapX == null ? null : _simpanLokasi,
            ...
            child: Center(
              child: Stack(
                children: [
                  ...
                  if (_tapX != null && _tapY != null && _imgWidth > 0)
                    Positioned(
                      left: (_tapX! * _imgWidth) - 20,
                      top: (_tapY! * _imgHeight) - 40,
                      child: const Icon(
                        Icons.location_on,
                        color: Colors.red,
                        size: 40,
      ...
      bottomNavigationBar: Container(
        ...
        child: Text(
          _tapX == null
              ? "Geser & Zoom, lalu KLIK pada peta."
              : "Titik terpilih. Tekan Ceklis di pojok kanan atas.",
